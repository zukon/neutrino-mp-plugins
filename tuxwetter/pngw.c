...
#ifdef MARTII
int fh_png_load(const char *name,unsigned char *buffer,int x __attribute__((unused)),int y __attribute__((unused)))
#else
...
#ifdef MARTII
int fh_png_getsize(const char *name,int *x,int *y, int wanted_width __attribute__((unused)), int wanted_height __attribute__((unused)))
#else
